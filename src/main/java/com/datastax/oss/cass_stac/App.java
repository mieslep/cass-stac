...
public class App {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String sampleFeatureCollectionString = sampleFeatureCollectionJson();
        FeatureCollection featureCollection = objectMapper.readValue(sampleFeatureCollectionString, FeatureCollection.class);
